 ...
 * <li>- NB_MAX_PERSONNES_TROP_PETIT : le nombre de personnes maximum est trop petit</li>
 ...
 * <li>- DATE_AGE_IMPOSSIBLE : la date est trop ancienne</li>
 * <li>- VILLE_NULL : le nom de la ville est null</li>
 ...
 * l'événement</li>
 * <li>- NBINSCRIT_TROP_PETIT : le nombre d'inscrits est inférieur au nombre minimal</li>
 ...
 * <li>- EVENEMENT_INEXISTANT : l'évènement de la participation n'existe pas</li>
...
public enum CodeErreur {
  ...
  AJOUT_MEMBRE_IMPOSSIBLE, 
  MODIFICATION_EVENEMENT_IMPOSSIBLE, 
  MODIFICATION_MEMBRE_IMPOSSIBLE, 
  SUPPRESSION_EVENEMENT_IMPOSSIBLE, 
  SUPPRESSION_MEMBRE_IMPOSSIBLE, 
  MEMBRE_INTROUVABLE, 
  ...
  MDP_INCORRECT, 
  NO_ERROR, 
  PARTICIPATION_DEJA_EXISTANTE, 
  NBINSCRIT_TROP_GRAND, 
  NBINSCRIT_TROP_PETIT, 
  AJOUT_PARTICIPATION_IMPOSSIBLE, 
  MEMBRE_INEXISTANT, 
  EVENEMENT_INEXISTANT, 
  MEMBRE_NULL, 
  EVENEMENT_NULL, 
  MODIFICATION_PARTICIPATION_IMPOSSIBLE, 
  PARTICIPATION_INEXISTANTE, 
  SUPPRESSION_PARTICIPATION_IMPOSSIBLE
}
