...
class SetNomEvenementTest {
    ...
    void testEspaceAvant() {
        assertEquals(CodeErreur.NOM_ESPACE_EN_TROP, unEvenement.setNom("   espaces avant"), "Le retour devrait être un code d'erreur NOM_ESPACE_EN_TROP");  
    ...
    void testEspaceApres() {
        assertEquals(CodeErreur.NOM_ESPACE_EN_TROP, unEvenement.setNom("espaces après    "), "Le retour devrait être un code d'erreur NOM_ESPACE_EN_TROP");  
        assertEquals(null, unEvenement.getNom(), "Le nom devrait être égal à null");  
    }
    ...
    void testCinquanteCara() {
        assertEquals(CodeErreur.NOM_TROP_LONG, unEvenement.setNom("abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz"), "Le retour devrait être un code d'erreur NOM_TROP_LONG");  
        assertEquals(null, unEvenement.getNom(), "Le nom devrait être égal à null");  
    }
    ...
    void testNull() {
        assertEquals(CodeErreur.NOM_NULL, unEvenement.setNom(null), "Le retour devrait être un code d'erreur NOM_NULL");  
    ...
    void testVide() {
        assertEquals(CodeErreur.NOM_VIDE, unEvenement.setNom(""), "Le retour devrait être un code d'erreur NOM_VIDE");  
        assertEquals(null, unEvenement.getNom(), "Le nom devrait être égal à null (inchangé)");  
    }
}