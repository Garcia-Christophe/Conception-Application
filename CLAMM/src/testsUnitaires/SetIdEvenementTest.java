...
class SetIdEvenementTest {
    ...
    void testZero() {
      assertEquals(CodeErreur.ID_NEGATIF, unEvenement.setId(0), "Le retour devrait être un code d'erreur ID_NEGATIF");  
    ...
    @DisplayName("Test unId égal à -1")
    void testNegatifUn() {
      assertEquals(CodeErreur.ID_NEGATIF, unEvenement.setId(-1), "Le retour devrait être un code d'erreur ID_NEGATIF");  
      assertEquals(0, unEvenement.getId(), "L'identifiant devrait être égal à 0 (inchangé)");  
    }
    ...
    void testNegatifTrois() {
      assertEquals(CodeErreur.ID_NEGATIF, unEvenement.setId(-3), "Le retour devrait être un code d'erreur ID_NEGATIF");  
      assertEquals(0, unEvenement.getId(), "L'identifiant devrait être égal à 0 (inchangé)");  
    }
}