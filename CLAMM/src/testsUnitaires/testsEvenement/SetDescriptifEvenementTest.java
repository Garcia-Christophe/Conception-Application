...
class SetDescriptifEvenementTest {
    ...
    void testCorrect() {
        assertEquals(null, unEvenement.setDescriptif("Organisation d’un repas de noël pour l’année 2022. Au programme un repas et différentes activités."), "Le retour devrait être null");  
        assertEquals("Organisation d’un repas de noël pour l’année 2022. Au programme un repas et différentes activités.", unEvenement.getDescriptif(), "Le descriptif devrait être égal à 'Organisation d’un repas de noël pour l’année 2022. Au programme un repas et différentes activités.'");  
    }
    ...
    void testEspaceAvant() {
        assertEquals(CodeErreur.DESCRIPTIF_ESPACE_EN_TROP, unEvenement.setDescriptif("   espaces avant"), "Le retour devrait être un code d'erreur DESCRIPTIF_ESPACE_EN_TROP");  
    ...
    void testEspaceApres() {
        assertEquals(CodeErreur.DESCRIPTIF_ESPACE_EN_TROP, unEvenement.setDescriptif("espaces après    "), "Le retour devrait être un code d'erreur DESCRIPTIF_ESPACE_EN_TROP");  
        assertEquals(null, unEvenement.getDescriptif(), "Le descriptif devrait être égal à null");  
    }
    ...
    void testNull() {
        assertEquals(CodeErreur.DESCRIPTIF_NULL, unEvenement.setDescriptif(null), "Le retour devrait être un code d'erreur DESCRIPTIF_NULL");  
