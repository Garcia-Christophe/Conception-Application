...
class SetImageEvenementTest {
  ...
  void testCorrecte() {
      assertEquals(null, unEvenement.setImage("https://www.google.com/image/chat.gif"), "Le retour devrait être null");  
      assertEquals("https://www.google.com/image/chat.gif", unEvenement.getImage(), "L'image devrait être : https://www.google.com/image/chat.gif");  
  }
