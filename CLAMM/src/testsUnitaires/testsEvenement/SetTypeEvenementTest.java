...
class SetTypeEvenementTest {
  ...
  void testCorrect() {
      ...
      assertEquals(TypeEvenement.REPAS, unEvenement.getType(), "Le type de l'évènement devrait être égal à REPAS");  
  }
  
  @Test                                               
  @DisplayName("Test unEvenement null")   
  void testTypeNull() {
      assertEquals(CodeErreur.TYPE_NULL, unEvenement.setType(null), "Le retour devrait être un code erreur TYPE_NULL");  
      assertEquals(null, unEvenement.getType(), "Le type de l'évènement devrait être null (inchangé)");  
  }
